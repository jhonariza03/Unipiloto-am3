...
var express = require('express')
  , path    = require('path') //modulo de node.js pre instalado sirve para moverse entre las carpetas
  , bodyParser = require('body-parser')
  , cons = require('consolidate');

// Creando la primera instancia de mi aplicacion
var app = express(); // crea el servidor de peticion HTTP

var debug = require('debug')('lab9');
